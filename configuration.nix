	...
	displayManager.lightdm.enable = false;
      ...
      pipewire = {
	     ...
	     wireplumber = {
	       enable = true;
         extraConfig = {
              # Disable restore overriding your setting
              "00-disable-restore" = {
                "wireplumber.settings" = {
                  "restore-default-targets" = false;
                };
              };

              # Set your default sink explicitly
              "10-default-sink" = {
                "default.nodes" = {
                  "default.configured.audio.sink" = "alsa_output.pci-0000_13_00.6.analog-stereo";
                };
              };
            };
         };
